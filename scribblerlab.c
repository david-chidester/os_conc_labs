...
int main() // main function calls the functions for all of the songs. They all play in the sequence in which they're called.
{
  ...
  eSpeakDisconnect(); // This ouputs the above sentence to espeak. A male or female voice is chosen at random.
  ...
  eSpeakDisconnect(); // The above message plays at the end of the program once all of the songs have been played.
